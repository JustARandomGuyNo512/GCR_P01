...
public class ClientTestingResources {
    ...
    public static void init(FMLClientSetupEvent event) {
        ...
        // 常规单行注册
        ModelRegistrationManager.registerModel(GCR.M4_PROFILE_FSB_BARREL, "model_assets/gltf/m4_profile_fsb_barrel.gltf", "model_assets/gltf/m4_profile_fsb_barrel.png", true, d -> new BarrelModel(d, 2f, CommonMuzzleFlashes.COMMON, 2.5f, CommonMuzzleSmokeEffects.COMMON));
        ModelRegistrationManager.registerModel(GCR.A2_FLASH_HINDER, "model_assets/gltf/a2_flash_hider.gltf", "model_assets/gltf/a2_flash_hider.png", true, d -> new MuzzleModel(d, 2f, CommonMuzzleFlashes.COMMON, 2.5f, CommonMuzzleSmokeEffects.COMMON));
        ...
        ModelRegistrationManager.registerModel(GCR.URGI_BARREL, "model_assets/gltf/urgi_barrel.gltf", "model_assets/gltf/urgi_barrel.png", true, d -> new BarrelModel(d, 2f, CommonMuzzleFlashes.COMMON, 2.5f, CommonMuzzleSmokeEffects.COMMON));
